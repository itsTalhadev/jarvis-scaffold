...
type CheckboxRoot = typeof CheckboxPrimitive.Root
type CheckboxRef = React.ComponentRef<CheckboxRoot>
type CheckboxProps = React.ComponentPropsWithoutRef<CheckboxRoot>
